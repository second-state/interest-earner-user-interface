...
async function updateBalances() {
    ...
    if (stakingAmounts.getTotalStateStaked().add(stakingAmounts.getTotalExpectedInterest()).add(new ethers.BigNumber.from("1000000000000000000")) >= stakingAmounts.getReservePool()){
